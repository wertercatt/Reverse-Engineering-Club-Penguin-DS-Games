    ...
    function L0_0()
      ...
      if L0_1 == 3 then
        ...
        if L0_1 > 3 then
          ...
          _util.MoveObject(_id.TroughHor1Left, L0_1, L1_2, L2_3, 1)
          repeat
            scriptWait()
          until _util.GetX(_util.GetSelf()) == L0_1 and _util.GetX(_id.TroughHor1Left) == L0_1
          _util.DecVar("hor1Location")
          _util.EnableInput()
      end
      else
        L0_1 = _util
