...
if L0_0 == _const.TOUCHED then
  function L0_0()
    if _util.IsCommandCoachActive() or _util.HasSnakePiece(_id.SNAKE_PIECE_4) == false then
      _util.DisplayPopUp(_text.M8_ITEM_SNAKEPIECE, "UI/Zoom/snakeGadget")
      _util.UnlockSnakePiece(_id.SNAKE_PIECE_4)
      _util.DelItem(_id.M9_MineShack_SnakePiece)
      _util.DisableInput()
      repeat
        scriptWait()
      until 120 - 1 == 0
